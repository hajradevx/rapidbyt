...
useSeoMeta({
  ...
  description: 'Get your free website performance audit from RapidByt. We\'ll identify what\'s slowing you down and send a prioritised fix report within 24 hours.',
})
...
const contactInfo = [
  { icon: 'i-lucide-mail', label: 'Email us', value: 'info.rapidbyt@gmail.com', href: 'mailto:info.rapidbyt@gmail.com' },
  { icon: 'i-lucide-message-circle', label: 'WhatsApp', value: '+92 316 863 6339', href: 'https://wa.me/923168636339' },
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto">
          Fill in your details below and we'll analyse your site for speed, SEO, security, and code issues — and send you a prioritised report within 24 hours.
        </p>
      </div>
      ...
      <div class="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
        ...
        <div class="lg:col-span-2">
          ...
          <div
            ...
            <div class="w-16 h-16 rounded-2xl bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center mx-auto mb-6">
              <UIcon name="i-lucide-check-circle" class="w-8 h-8 text-emerald-600" />
            </div>
            <h2 class="text-2xl font-black text-zinc-900 dark:text-white mb-3">
              Request sent!
            </h2>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <UButton label="Back to Home" to="/" variant="outline" color="neutral" class="w-full sm:w-auto" />
            </div>
          </div>

          <!-- Form -->
          <form v-else class="space-y-6 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 sm:p-10" @submit.prevent="handleSubmit">
        ...
        <div class="space-y-6">
          <!-- Contact info -->
          <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 space-y-5">
            ...
            <div
              ...
              <div>
                ...
                <a v-if="c.href" :href="c.href" class="text-sm font-semibold text-zinc-800 dark:text-zinc-200 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">{{ c.value }}</a>
          ...
          <!-- What you get -->
          <div class="rounded-2xl border border-sky-200 dark:border-sky-800 bg-sky-50 dark:bg-sky-900/20 p-6">
          ...
          <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6">
            <div class="flex items-center gap-0.5 mb-2">
              <UIcon v-for="n in 5" :key="n" name="i-lucide-star" class="w-3.5 h-3.5 text-amber-400 fill-amber-400" />
            </div>
            <p class="text-sm text-zinc-500 dark:text-zinc-400 italic mb-3">
              "Submitted the form on Monday evening. Had a full 12-page audit in my inbox Tuesday morning. Incredibly detailed."
            </p>
