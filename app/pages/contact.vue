    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto">
          Fill in your details below and we'll analyse your site for speed, SEO, security, and code
          issues — and send you a prioritised report within 24 hours.
        </p>
      </div>
            ...
            <div v-for="c in contactInfo" :key="c.label" class="flex items-start gap-3">
              ...
              <div>
                ...
                <a
                  v-if="c.href"
                  :href="c.href"
                  class="text-sm font-semibold text-zinc-800 dark:text-zinc-200 hover:text-sky-600 dark:hover:text-sky-400 transition-colors"
                  >{{ c.value }}</a
                >
