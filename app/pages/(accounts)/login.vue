    ...
    <UPageCard class="max-w-md w-full">
      <UAuthForm
        ...
        <template #description>
          New to the collective? <ULink to="/register" class="text-primary font-medium">Join now</ULink>.
        </template>
        <template #password-hint>
          <ULink to="/forgot-password" class="text-primary font-medium" tabindex="-1">Forgot password?</ULink>
        </template>
        <template #footer>
          By signing in, you agree to our <ULink to="/terms" class="text-primary-500 font-bold uppercase tracking-widest text-[10px]">Terms of Tech</ULink>.
        </template>
      </UAuthForm>
    </UPageCard>
  </UMain>
